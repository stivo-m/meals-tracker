...
import 'package:meal_tracker/services/auth/base_auth_service.dart' as _i14;
...
///
/// See the documentation for Mockito's code generation for more information.
class MockBaseAuthService extends _i1.Mock implements _i14.BaseAuthService {
  MockBaseAuthService() {
    _i1.throwOnMissingStub(this);
  }

  // @override
  // _i7.Future<dynamic> get currentUser =>
  //     (super.noSuchMethod(Invocation.getter(#currentUser),
  //         returnValue: Future<dynamic>.value(null)) as _i7.Future<dynamic>);
  @override
  _i7.Future<dynamic> loginWithEmailAndPassword(
          String? email, String? password) =>
      (super.noSuchMethod(
  ...
  _i7.Future<dynamic> registerWithEmailAndPassword(
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<dynamic>.value(null)) as _i7.Future<dynamic>);
  @override
  _i7.Future<dynamic> signInWithGoogle() =>
